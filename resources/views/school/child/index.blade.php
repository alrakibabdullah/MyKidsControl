                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        @foreach($child as $data)
                                            ...
                                            @endphp
                                                ...
                                                <td>
                                                    {{-- <a href="{{route('school-child.edit',$data->id)}}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a> --}}
                                                    <a href="#"  style="display: inline;" class="btn btn-success btn-sm" onclick="ViewParentProfile({{$data->id}})"  data-toggle="modal"
                                                        ...
                                                        <a href="{{route('school-child.schedule',$data->id)}}" class="btn btn-warning btn-sm"><i class="fas fa-clock"></i></a>
                                                </td>
                                            </tr>
                                            @php $i++; @endphp
                                        @endforeach
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
    <script>
        ...
        function ViewParentProfile(id) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo route('school-parent-profile'); ?>",
                data: datastr,
                cache: false,
