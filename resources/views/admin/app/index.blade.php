...
@section('title')
<title>{{ config('app.name') }} | Manage Apps</title>
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Apps Form</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                    ...
                    <div class="card card-primary website-form">
                        ...
                        <form role="form" action="{{route('apps.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Apps Name<span style="color: red">*</span></label>
                                    <input type="text" name="name" class="form-control" id="exampleInputEmail1" placeholder="Apps Name">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Apps Link<span style="color: red">*</span></label>
                                    <input type="text" name="link" class="form-control" id="exampleInputEmail1" placeholder="Apps Link">
                                </div>
                                <div class="form-group">
